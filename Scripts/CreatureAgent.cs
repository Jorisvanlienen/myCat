...
public class CreatureAgent : Agent
{
    ...
    //{
      //  Monitor.Log("Action", currentAction, MonitorType.text, transform);
        //Monitor.Log("Size", Size / MatureSize, MonitorType.slider, transform);
        //Monitor.Log("Energy", Energy / MaxEnergy, MonitorType.slider, transform);
        //Monitor.Log("Age", Age / MatureSize, MonitorType.slider, transform);
    //}
